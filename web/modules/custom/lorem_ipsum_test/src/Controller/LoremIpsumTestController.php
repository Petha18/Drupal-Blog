...
namespace Drupal\lorem_ipsum_test\Controller;
 ...
 */
class LoremIpsumTestController {
  ...
  public function generate($paragraphs, $phrases) {
    // Default settings.
    $config = \Drupal::config('lorem_ipsum_test.settings');
    // Page title and source text.
    $page_title = $config->get('lorem_ipsum_test.page_title');
    $source_text = $config->get('lorem_ipsum_test.source_text');

    // Create repertory based on source_text.
    ...
    // Theme function.
    $element['#theme'] = 'lorem_ipsum_test';
